function dossiers(id, data) {
	...
	var svg = d3.select(id).append("svg")
	  ...
	  g.append("path")
	      .attr("d", arc)
	      .style("fill", function(d) { return color(d.data.statTitle); });
      ...
      .text(function(d, i) { return d.data.statTitle; });
	  ...
	  function legend(lD){
	        ...
	        tr.append("td").append("svg").attr("width", '16').attr("height", '16').append("rect")
				...
				.attr("fill",function(d){ return color(d.statTitle); });
	            
	        // create the second column for each segment.
	        tr.append("td").text(function(d){ return d.statTitle;});
