 ...
 * 
 */
var dossierStageController = angular.module('DossierStageController', ['ngRoute', 'dossierStageServices']);

dossierStageController.controller('DossierStageController', ['$rootScope', '$http', '$scope', '$location', '$filter', '$timeout', 'DossierStageService', function($rootScope, $http, $scope, $location, $filter, $timeout, DossierStageService) {
	...
	$scope.search = function() {
		...
		DossierStageService.list.query({query: $scope.query, groupe: $scope.groupe, sansGroupe: $scope.sansGroupe, dossierStatut: $scope.dossierStatut, creneau: $scope.creneau, filter_facture: $scope.facture, filter_facture2: $scope.facture2, certificat: $scope.certificat, certificat2: $scope.certificat2, certificatNon: $scope.certificatNon}, function(data) {
			$scope.dossiers = data;
