...
public class SwimmerStatYearActivity extends MyAbstractActivity<SwimmerStatPlace> {

	private SwimmerStatEnum kind;

	public SwimmerStatYearActivity(SwimmerStatPlace pPlace,
	...
	public void start(AcceptsOneWidget pPanel, EventBus pEventBus) {
		...
		dispatchAsync.execute(new GetAllSwimmerStatAction(kind, new Date(),
			...
			public void onSuccess(GetAllSwimmerStatResult<?> pResult) {
				PopupManager.getInstance().hide();
				final SwimmerStatYearView lView = clientFactory
						.getSwimmerStatYearView((List<SwimmerStatYearUi>) pResult
								.getResults());
								...
								new AsyncCallback<GetAllSwimmerStatResult<?>>() {
									...
									public void onSuccess(
										...
										lView.setCurrentDayText(pResult
												.getCurrentDayText());
										lView.setData((List<SwimmerStatYearUi>) pResult
												.getResults());
									}
								});
					}
