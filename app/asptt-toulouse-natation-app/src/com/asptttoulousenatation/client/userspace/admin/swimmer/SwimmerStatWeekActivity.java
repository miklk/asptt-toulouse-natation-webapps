...
public class SwimmerStatWeekActivity extends MyAbstractActivity<SwimmerStatPlace> {

	private SwimmerStatEnum kind;

	public SwimmerStatWeekActivity(SwimmerStatPlace pPlace,
	...
	public void start(AcceptsOneWidget pPanel, EventBus pEventBus) {
		...
		dispatchAsync.execute(new GetAllSwimmerStatAction(kind, new Date(),
			...
			public void onSuccess(GetAllSwimmerStatResult<?> pResult) {
				PopupManager.getInstance().hide();
				final SwimmerStatWeekView lView = clientFactory
						.getSwimmerStatWeekView((List<SwimmerStatWeekUi>) pResult
								.getResults());
								...
								new AsyncCallback<GetAllSwimmerStatResult<?>>() {
									...
									public void onSuccess(
										...
										lView.setCurrentDayText(pResult
												.getCurrentDayText());
										lView.setData((List<SwimmerStatWeekUi>) pResult
												.getResults());
									}
								});
					}
